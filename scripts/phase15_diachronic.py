...
MEASURES (per period, Administrative genre only, gold probes only)
------------------------------------------------------------------
...
def main() -> None:
    ...
    md.append("**The historiographic stake.** Steinkeller's canonical account treats Ur III under "
              "Shulgi as a sharp bureaucratic break — standardized bookkeeping, the bala system, a "
              "fixed formula repertoire — while Selz argues many 'Shulgi reforms' have Early Dynastic "
              "forerunners, a continuity thesis. A quantitative formula-standardization trajectory "
              "speaks directly to gradual-accretion vs. sharp-discontinuity, and to our knowledge "
              "(novelty sweep, 2026-08-06) no quantitative diachronic study of administrative-formula "
              "standardization across these periods exists. Closest neighbours: Nissen/Damerow/Englund "
              "on proto-cuneiform (earlier period), Tsouparopoulou's sealing database (one practice, "
              "one site, one period), BDTNS corpus statistics (Ur III only).\n\n")
    md.append("**Caveat 1 — surviving record, not practice.** Different city archives dominate "
              ...
              "kišib₃ TEXT clauses (25.4% in Ur III), not physical seal impressions (BDTNS reports "
              "~35.7% of Ur III tablets physically sealed); the two measure different things and both "
              "can be right. **Caveat 3 — formula spelling itself evolves.** A period where the "
              ...
              "here. **Caveat 4 — low placement entropy alone proves nothing.** Fixed tablet layout "
              "can hold positional entropy low in every period for reasons unrelated to "
              "standardization (cf. arXiv:2608.02999 on the non-specificity of such measures); only "
              "the length-stratified DIACHRONIC DELTA (S2) is claimed, never a single period's "
